...
export default function ProductPage() {
  ...
  return (
    <>
      ...
      >
        <div className="w-full mx-auto max-w-[1200px] flex items-center justify-between py-8 sm:py-8" style={{ paddingLeft: '25px', paddingRight: '25px', boxSizing: 'border-box' }}>
