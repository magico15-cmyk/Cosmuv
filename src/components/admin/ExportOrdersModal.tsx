      ...
      <div className="bg-white rounded-xl w-full max-w-4xl shadow-xl overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="p-6 grid grid-cols-2 gap-6 pb-0">
          <div ref={statusRef} className="relative">
            ...
            <div 
              className="relative w-full pl-4 pr-10 py-2.5 bg-white border border-gray-200 hover:border-gray-300 transition-colors rounded-lg text-sm cursor-pointer flex justify-between items-center"
          ...
          <div ref={dateRef} className="relative">
            ...
            <div 
              className="relative w-full pl-10 pr-4 py-2.5 bg-white border border-gray-200 hover:border-gray-300 transition-colors rounded-lg text-sm cursor-pointer flex items-center justify-between"
